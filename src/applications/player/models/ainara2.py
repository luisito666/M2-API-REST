...
class Player(models.Model):
    ...
    random_hp = models.PositiveSmallIntegerField()
    random_sp = models.PositiveSmallIntegerField()
    ...
    gaya = models.PositiveIntegerField()
    money_cheque = models.BigIntegerField()
    money2 = models.BigIntegerField()
    shop_gold = models.IntegerField()
    shop_cheque = models.IntegerField()
    combat_zone_rank = models.IntegerField()
    combat_zone_points = models.IntegerField()
    ...
    part_main = models.PositiveSmallIntegerField()
    ...
    change_empire = models.IntegerField()
    zodiac_point = models.IntegerField()
    last_zodiac_point_reward = models.IntegerField()
    bead = models.IntegerField()
    extend_inventory = models.IntegerField()
